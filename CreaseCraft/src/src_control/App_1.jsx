                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {isPastPlan && (
                              <button
                                ...
                                className="bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold text-xs px-3.5 py-1.5 rounded-xl transition-all shadow"
                              >
                                ✓ Verify & Log
                              </button>
                            )}
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    console.error("Error logging workload to Firestore:", err);
                  }
                }}
                className="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold text-xs py-3 rounded-xl transition-all shadow mt-2"
              >
