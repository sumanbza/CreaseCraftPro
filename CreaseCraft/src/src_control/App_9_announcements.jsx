  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans antialiased overflow-x-hidden">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* TAB 6: CLUB & SQUAD COMMUNICATION & ANNOUNCEMENTS HUB (STRICT PLAYER SQUAD FILTER) */}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {announcements.filter(ann => {
                ...
                // FIXED ANNOUNCEMENT FILTER LOGIC:
                // 1. Club-wide announcements ('ALL') are always visible to everyone in the club.
                if (ann.targetSquadId === 'ALL') return true;
                
                // 2. Squad-specific announcements are strictly visible only if the user is assigned to that squad.
